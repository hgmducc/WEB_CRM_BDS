...
export function toast({
  ...
  window.dispatchEvent(
    new CustomEvent(busName, { detail: { id: Date.now() + Math.random(), title, message, type, duration } })
  );
}
...
export function ToastHost() {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener(busName, onToast);
    return () => window.removeEventListener(busName, onToast);
  }, []);
